...
class ece_1896_STARR_FM_(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ECE 1896 STARR FM RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ECE 1896 STARR FM RX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ece_1896_STARR_FM_")
        ...
        self.audio_volume_gain = audio_volume_gain = 0.1
        ...
        self._rf_gain_range = qtgui.Range(0, 64, 1, 40, 200)
        ...
        self._audio_volume_gain_range = qtgui.Range(0, 2, 0.01, 0.1, 200)
        ...
        self.qtgui_freq_sink_x_1_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            RF_samp_rate, #bw
            "RF Downconverted Signal After LP", #name
            1,
            None # parent
        )
        ...
        self.blocks_wavfile_sink_0_0_0 = blocks.wavfile_sink(
            '/home/adam-nichols/Documents/Pitt/ECE 1896/RFImagTestMessage.wav',
            1,
            audio_samp_rate,
            blocks.FORMAT_WAV,
        ...
        self.blocks_wavfile_sink_0_0 = blocks.wavfile_sink(
            '/home/adam-nichols/Documents/Pitt/ECE 1896/RFRealTestMessage.wav',
            1,
            audio_samp_rate,
            blocks.FORMAT_WAV,
            blocks.FORMAT_PCM_16,
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/adam-nichols/Documents/Pitt/ECE 1896/DemodulatedVoiceTestMessage.wav',
            1,
            audio_samp_rate,
            blocks.FORMAT_WAV,
            blocks.FORMAT_PCM_16,
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_wavfile_sink_0_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_wavfile_sink_0_0_0, 0))
    ...
    def set_RF_samp_rate(self, RF_samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.RF_samp_rate)
        self.qtgui_freq_sink_x_1_0.set_frequency_range(0, self.RF_samp_rate)




def main(top_block_cls=ece_1896_STARR_FM_, options=None):
