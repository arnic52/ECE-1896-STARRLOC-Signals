...
class ece_1896_STARR_FM_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ece_1896_STARR_FM_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ece_1896_STARR_FM_RX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ece_1896_STARR_FM_RX")
...
def main(top_block_cls=ece_1896_STARR_FM_RX, options=None):
