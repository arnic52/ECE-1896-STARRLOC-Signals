...
class ece_1896_STARR_FM_proc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ece_1896_STARR_FM_proc")
...
def main(top_block_cls=ece_1896_STARR_FM_proc, options=None):
